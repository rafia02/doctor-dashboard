    ...
    return (
        <div className='w-full'>
            <div className='grid grid-cols-1 md:grid-cols-2 my-8 md:gap-4'>
                {/* appointemnt request  */}
                <div className='py-6 px-4 bg-white  rounded-md shadow'>
                    <div className=''>
                ...
                <div className='py-6 px-4 bg-white rounded-md shadow'>
                    ...
                    <div className='flex gap-2 flex-col'>
                        <div className='text-xs flex duration-300 hover:bg-secondary p-2 rounded justify-between items-center text-gray-500'>
